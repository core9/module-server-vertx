...
public class CookieImpl implements Cookie, io.netty.handler.codec.http.Cookie {
	private final io.netty.handler.codec.http.Cookie nettyCookie;
    private final Mac hmacSHA256;
    private String value;
    private boolean signed;

    public CookieImpl(io.netty.handler.codec.http.Cookie nettyCookie, Mac hmacSHA256) {
    ...
    public CookieImpl(String name, Mac hmacSHA256) {
        this(new DefaultCookie(name, ""), hmacSHA256);
    }
    
    public CookieImpl(String name, String value, Mac hmacSHA256) {
        this(new DefaultCookie(name, value), hmacSHA256);
    }
	...
	@Override
	public int compareTo(io.netty.handler.codec.http.Cookie o) {
